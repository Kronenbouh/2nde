...
\item Les vecteurs $(\vec{u}-\vec{v})$ et $\vec{w}$ sont $\dots \dots$.
\end{enumerate}
...
\item Les vecteurs $(\vec{u}-\vec{v})$ et $\vec{w}$ sont égaux.
\end{enumerate}

}

\exe{2}{
On considère les points $A(2;5), B(5;3), C(7;-3)$ et $D(4;-1)$.
Calculer les coordonnées des vecteurs $\vec{AB}$ et $\vec{DC}$. En déduire la nature du quadrilatère $ABCD$.
}{exe:pme1_a}{
$\vec{AB} \pvec{3}{-2}, \vec{DC} \pvec{3}{-2}, \vec{AB} = \vec{DC}$ donc $ABCD$ est un parallélogramme.
}
...
\item les $(\vec{u}-\vec{v})$ et $\vec{w}$ sont égaux.
\end{enumerate}
}

\exe{2}{
On considère les points $A(5;2), B(3;5), C(-3;7)$ et $D(-1;4)$.
Calculer les coordonnées des vecteurs $\vec{AB}$ et $\vec{DC}$. En déduire la nature du quadrilatère $ABCD$.
}{exe:pme1_b}{
$\vec{AB} \pvec{-2}{3}, \vec{DC} \pvec{-2}{3}, \vec{AB} = \vec{DC}$ donc $ABCD$ est un parallélogramme.
}
